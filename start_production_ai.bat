...
REM Check if AI models exist
if not exist "data\emergency_training\trained_models\rf_classifier.pkl" (
...
if exist "production_config.json" (
...
REM Start the production trader
