...
eth_btc_stats = {
    'mean_profit_pct': eth_btc_path['profit_percentage'].mean(),
    'max_profit_pct': eth_btc_path['profit_percentage'].max(),
    'min_profit_pct': eth_btc_path['profit_percentage'].min(),
    'std_profit_pct': eth_btc_path['profit_percentage'].std(),
}

btc_eth_stats = {
    'mean_profit_pct': btc_eth_path['profit_percentage'].mean(),
    'max_profit_pct': btc_eth_path['profit_percentage'].max(),
    'min_profit_pct': btc_eth_path['profit_percentage'].min(),
    'std_profit_pct': btc_eth_path['profit_percentage'].std(),
}

print('\nCAD->ETH->BTC->CAD Statistics:')
print(f'Mean Profit %: {eth_btc_stats["mean_profit_pct"]:.4f}%')
print(f'Max Profit %: {eth_btc_stats["max_profit_pct"]:.4f}%')
print(f'Min Profit %: {eth_btc_stats["min_profit_pct"]:.4f}%')
print(f'Std Dev: {eth_btc_stats["std_profit_pct"]:.4f}%')

print('\nCAD->BTC->ETH->CAD Statistics:')
print(f'Mean Profit %: {btc_eth_stats["mean_profit_pct"]:.4f}%')
print(f'Max Profit %: {btc_eth_stats["max_profit_pct"]:.4f}%')
print(f'Min Profit %: {btc_eth_stats["min_profit_pct"]:.4f}%')
print(f'Std Dev: {btc_eth_stats["std_profit_pct"]:.4f}%')
...
analysis_results = {
    ...
    'eth_btc_stats': eth_btc_stats,
    'btc_eth_stats': btc_eth_stats,
...
if eth_btc_stats['mean_profit_pct'] > btc_eth_stats['mean_profit_pct']:
